...
public class CallDetectionService extends Service {
    ...
    private void pauseAudioServices() {
        ...
        try {
            com.mvp.sarah.FeedbackProvider.shutdown();
        } catch (Exception e) {
    ...
    private void startCallCommandListening() {
        ...
        filter.addAction("com.mvp.sarah.CALL_COMMAND");
    ...
    private void answerCall() {
        ...
        Intent intent = new Intent("com.mvp.sarah.ACTION_ANSWER_CALL");
    ...
    private void rejectCall() {
        ...
        Intent intent = new Intent("com.mvp.sarah.ACTION_REJECT_CALL");
        intent.putExtra("phone_number", currentCallerNumber);
        sendBroadcast(intent);
    }
    ...
    private void startAutomaticVoiceRecognition() {
        ...
        Intent intent = new Intent("com.mvp.sarah.START_CALL_LISTENING");
        intent.putExtra("phone_number", currentCallerNumber);
    ...
    private void stopAutomaticVoiceRecognition() {
        ...
        Intent intent = new Intent("com.mvp.sarah.STOP_CALL_LISTENING");
        sendBroadcast(intent);
    }
} 